...
function [finalImg] = sho1(inputImg,N,iter,f,list) % n-no of population,iter-no of iterations, f-fitness function
    close all
    ...
    xl=0;
    xu=500;
    fprintf('lower-%f, upper-%f \n',baseAgent(1),baseAgent(end)); 

    numIntensities = size(baseAgent,2);    
    A = dataCreate(numAgents,numIntensities);
    %A = A-1;
